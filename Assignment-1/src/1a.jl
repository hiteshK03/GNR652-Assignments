...
X_test = cat(x1, test_data.bathrooms, test_data.bedrooms, test_data.sqft_living, dims=2)
...
learningRate = 0.001
numIterations = 20000
newB, costHistory = gradientDescent(X, Y, B, learningRate, numIterations)
...
CSV.write("./data/1a.csv", DataFrame(Y_pred), writeheader=false)
